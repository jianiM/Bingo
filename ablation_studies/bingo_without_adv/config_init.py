...
def get_config():
    ...
    parse.add_argument('-model_saving_path', '--model_saving_path_topofallfeature', type=str, nargs='?', default= "/home/amber/Bingo_balanced/human_experiments/biogen_without_adv/gat_based/kfold_model_saving/", help="path for saving the models") 
