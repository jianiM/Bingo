...
def get_config():
    ...
    parse.add_argument('-root_path', '--root_path_topofallfeature', type=str, nargs='?', default="/home/amber/Bingo_balanced/data/",help="root dataset path")
    ...
    parse.add_argument('-modelling', '--modelling_topofallfeature', type=str, nargs='?', default= "graphsage", help="gnn model choice") 
    parse.add_argument('-model_saving_path', '--model_saving_path_topofallfeature', type=str, nargs='?', default= "/home/amber/Bingo_balanced/human_experiments/biogen/graphsage_based/kfold_model_saving/", help="path for saving the models") 
