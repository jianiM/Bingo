...
def get_config():
    ...
    parse.add_argument('-embed_dim', '--embed_dim_topofallfeature', type=int, nargs='?', default=512, help='embedding dimension of ')
    parse.add_argument('-pad_idx', '--pad_idx_topofallfeature', type=int, nargs='?', default=1, help="padding index") 
    parse.add_argument('-channels', '--channels_topofallfeature', type=list, nargs='?', default=[128,64,16], help="padding index") 
    parse.add_argument('-kernel', '--kernel_topofallfeature', type=int, nargs='?', default=5, help="kernel size")  
    ...
    parse.add_argument('-model_saving_path', '--model_saving_path_topofallfeature', type=str, nargs='?', default= "/home/amber/Bingo_balanced/human_experiments/cnn/kfold_model_saving/", help="path for saving the models") 
    ...
    parse.add_argument('-lr', '--lr_topofallfeature', type=float, nargs='?', default=1e-4,help='learning rate')
